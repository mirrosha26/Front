...
// Get list of all available filters for signals
export async function GET(request: NextRequest) {
  try {
    ...
    // Form URL for API filters request
    const apiUrl = new URL(config.api.filters.endpoints.allSignals);
...
// Send selected filters for signals
