...
import { useDeletedCardsGraphQLActions } from '../hooks/use-deleted-cards-graphql';
...
export function DeletedCardsPage() {
  ...
  // Card restore handler
  const handleRestore = (cardId: number) => {
    ...
    <div className='w-full px-4 py-2 sm:px-6'>
      ...
      <div className='bg-background sticky top-0 z-10 pt-4 pb-4 w-full'>
        <div className='flex items-center justify-between w-full'>
          <h1 className='text-2xl font-bold tracking-tight'>Скрытые карточки</h1>
      ...
      <div className='py-4 w-full'>
        ...
        {isLoading && deletedCards.length === 0 ? (
          ...
          <CardsList
            ...
            variant='deleted'
            emptyMessage='No deleted cards found'
        ...
        {deletedCards.length > 0 && (
          <InfiniteScroll
            ...
            currentCount={deletedCards.length}
