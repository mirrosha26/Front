...
interface DeletedCardsFiltersProps {
  onApply: (filters: Record<string, any>) => void;
  onClose: () => void;
  currentFilters: Record<string, any>;
}

export function DeletedCardsFilters({
  onApply,
  onClose,
  currentFilters
}: DeletedCardsFiltersProps) {
  ...
  const handleApplyFilters = () => {
    // Convert dates to DD.MM.YYYY format if not empty
  ...
  return (
    <div className='bg-background rounded-lg border p-4'>
      ...
      <div className='space-y-4'>
        ...
        {/* Deletion period */}
        <div className='space-y-2'>
          <Label>Deletion Period (DD.MM.YYYY)</Label>
          <div className='flex gap-2'>
            <Input
              type='text'
